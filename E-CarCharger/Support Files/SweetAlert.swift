...
open class SweetAlert: UIViewController {
    ...
    fileprivate func setupContentView() {
        contentView.backgroundColor = #colorLiteral(red: 0.8837149971, green: 1, blue: 0.7996501223, alpha: 1)   //UIColor(white: 1.0, alpha: 1.0)
        contentView.layer.cornerRadius = 5.0
        contentView.layer.masksToBounds = true
        contentView.layer.borderWidth = 0.5
        contentView.addSubview(titleLabel)
        contentView.addSubview(subTitleTextView)
        contentView.backgroundColor = #colorLiteral(red: 0.8837149971, green: 1, blue: 0.7996501223, alpha: 1)  //UIColor.colorFromRGB(0xFFFFFF)
        contentView.layer.borderColor = #colorLiteral(red: 0.831372549, green: 0.9843137255, blue: 0.4745098039, alpha: 1) //UIColor.colorFromRGB(0xCCCCCC).cgColor
    ...
    open func showAlert(_ title: String, subTitle: String?, style: AlertStyle,buttonTitle: String, action: ((_ isOtherButton: Bool) -> Void)? = nil) -> SweetAlert {
        _ = showAlert(title, subTitle: subTitle, style: style, buttonTitle: buttonTitle,buttonColor: #colorLiteral(red: 0.3411764801, green: 0.6235294342, blue: 0.1686274558, alpha: 1))
        userAction = action
        return self
    }
    ...
    open func showAlert(_ title: String, subTitle: String?, style: AlertStyle,buttonTitle: String,buttonColor: UIColor,otherButtonTitle:
        ...
        if buttonTitle.isEmpty == false {
            ...
            button.titleLabel?.font = UIFont(name: kFontDB, size:18)
