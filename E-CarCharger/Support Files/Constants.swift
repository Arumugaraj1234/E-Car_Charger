...
let TRACKVC_TO_HISTORYVC = "trackVcToHistoryVc"
...
let URL_TO_GET_BOOKING_INFO = BASE_URL + "GetBookingInfo"
let URL_TO_CHECK_ORDER_COMPLETE = BASE_URL + "CheckOrderComplete"
